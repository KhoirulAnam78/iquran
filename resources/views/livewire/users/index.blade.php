    ...
    <div class="card card-height-100">
        ...
        <div class="card-header border-bottom-dashed align-items-center d-flex">
            ...
            <div class="flex-shrink-0">
                <a href="{{ route('user.create') }}" wire:navigate class="btn btn-soft-primary btn-sm">
                ...
                <table class="table table-nowrap table-striped-columns mb-0">
                    <thead class="table-light">
                        <tr>
                            ...
                            <th scope="col" wire:click='sortBy("guard_name")'>Roles <i
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <button class="btn btn-danger"
                                        wire:click="showDelete('{{ Crypt::encryptString($user->id) }}')"><i
        ...
        <div class="card-footer py-4 d-flex">
            <p class="flex-grow-1">Total data : {{ $users->total() }}</p>
